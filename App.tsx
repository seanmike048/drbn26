  ...
  if (loading) {
      return (
          <div className="min-h-screen bg-[#F6F4E8] flex flex-col items-center justify-center">
              <Loader2 className="w-8 h-8 text-[#9B7542] animate-spin mb-4" />
  ...
  return (
    <>
      ...
      {view === 'dashboard' && currentPlan && userProfile && (
          <>
            <TodayPlanPage plan={currentPlan} user={userProfile} lang={lang} />
      ...
      {view === 'evolution' && (
          <div className="min-h-screen bg-[#F6F4E8] flex items-center justify-center p-6 text-center">
              <div>
